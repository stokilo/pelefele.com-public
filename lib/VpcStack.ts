...
export default class VpcStack extends Stack {
  constructor(scope: App, id: string, props: AppStackProps) {
    ...
    props.sgForIsolatedSubnet = new ec2.SecurityGroup(
      this,
      constructId('vpc-sg-for-isolated-subnet', props),
      {
        vpc: props.vpc,
    ...
    props.sgForIsolatedSubnet.addIngressRule(
    ...
    props.vpc.addInterfaceEndpoint(
      constructId('ssm-interface-endpoint', props),
      {
    ...
    props.vpc.addInterfaceEndpoint(
      constructId('step-function-interface-endpoint', props),
      {
    ...
    props.vpc.addInterfaceEndpoint(
      constructId('sqs-interface-endpoint', props),
      {
